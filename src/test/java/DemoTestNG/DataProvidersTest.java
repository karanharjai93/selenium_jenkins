...
//    @Test(dataProviderClass = DataProviderOnly.class, dataProvider = "@Dataprovider")// Was just trying to run it without dataprovider name..but it didnt work..need to figure it out later.
